...
// Disable network to prevent real-time connection issues
// This will force Firestore to work in offline mode and avoid WebSocket connections
try {
  disableNetwork(db);
  console.log('Firestore network disabled to prevent connection issues');
} catch (error) {
